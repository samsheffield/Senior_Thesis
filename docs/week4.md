...
**Goal**: Get used to our weekly peer check-in/review structure.

**Time**: Plan to spend about 4–5 hours.

**Deliverable**: No submission for this one.


### Assignment Description:
Use this time to continue working on something connected to what you might want to do for your thesis. If you formed a team this week, you should decide collectively what kind of experimenting/prototyping is needed right now.
...
Collaboration breakout session (just chatting)
Week 2 (09/02)
...
Collaboration breakout session (for real this time!)
Week 4 (09/16)
